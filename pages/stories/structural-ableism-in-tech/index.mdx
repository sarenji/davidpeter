...
Now, [you shouldn’t blame one person](https://twitter.com/davidnoob/status/1273892826980298758) for what is an organizational failure. And Twitter [apologized for it](https://twitter.com/TwitterSupport/status/1273794890543935488). However, this is a problem at more than just Twitter. These rebuttals are tired and familiar, so I think it’s important to address them in turn.
...
A test is typically an experiment wherein a team releases a product to a number of users to see how users interact with it over a set amount of time. While not everyone could _make_ audio tweets, Twitter made it so all users could [_interact_ with audio tweets](https://twitter.com/mattbc/status/1273375349586436097).
...
Accessibility determines design, user interaction, user experience, and copy decisions, and so must be considered from the start of the product process. Accessibility is critical to a minimally viable product, just like security and data compliance.
...
But the problem runs deeper than just inaccessibility. Fixing accessibility issues is an endless game of whack-a-mole. You can't win. The problem is [ableism](https://www.selfdefined.app/definitions/ableism/), and to win you need to throw out the game.
...
We must be actively anti-ableist. Just as we build products with design systems, we must build an anti-ableist culture brick by brick. In an ableist world, [abled people make products for abled people](https://webaim.org/projects/million/).

To expand the audience for our products, we must actively seek out, retain, and promote disabled people, and not just disabled white cis men. BIPOC disabled people. Trans disabled people. Disabled people of any gender who are drawn to femininity. Work to [dismantle white supremacy](https://rewire.news/article/2018/11/19/ableism-is-the-go-to-disguise-for-white-supremacy-too-many-people-are-falling-for-it/), which exists in (and is perpetuated by) the disability community as well.
...
These resources may help you begin your accessibility journey. But, most likely, your biggest challenge will be ableist attitudes.
...
- [Equivalent experiences](https://www.smashingmagazine.com/2020/05/equivalent-experiences-part1/) ([Part two](https://www.smashingmagazine.com/2020/06/equivalent-experiences-part2/))
- [Supporting the Design Phase with Accessibility Heuristics Evaluations](https://www.deque.com/blog/supporting-the-design-phase-with-accessibility-heuristics-evaluations/)
- [Inclusive Components](https://inclusive-components.design/)
- [A11y with Lindsey](https://www.a11ywithlindsey.com/)
- [The A11y Project](https://a11yproject.com/patterns/)
- [24a11y](https://www.24a11y.com/)
- [technica11y](https://technica11y.org/)
